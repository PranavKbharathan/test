...
class __$$UpdateNameImplCopyWithImpl<$Res>
    extends _$HomeEventCopyWithImpl<$Res, _$UpdateNameImpl>
...
class _$UpdateNameImpl implements _UpdateName {
  ...
  @override
  String toString() {
    return 'HomeEvent.updateName(name: $name)';
  }
...
abstract class _UpdateName implements HomeEvent {
...
class _$HomeStateImpl implements _HomeState {
  const _$HomeStateImpl({required this.name});
...
abstract class _HomeState implements HomeState {
  const factory _HomeState({required final String name}) = _$HomeStateImpl;
